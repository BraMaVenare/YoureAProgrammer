...
namespace YoureAProgrammer.BackEnd.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "QuestionID,Title,Description,SkillId")] Questions questions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "QuestionID,Title,Description,SkillId")] Questions questions)
        {
            if (ModelState.IsValid)
            {
